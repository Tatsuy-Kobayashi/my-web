...
# 出力: set1 と set2 の和集合: {1, 2, 3, 4, 5}
print(f"{set1} と {set2} の和集合: {union_set}")

# 演算子を使用
intersection_set = set1 & set2
# intersection() メソッドを使用
intersection_set = set1.intersection(set2)
# 出力: set1 と set2 の積集合: {3}
print(f"{set1} と {set2} の積集合: {intersection_set}")

# 演算子を使用
difference_set = set1 - set2
# difference() メソッドを使用
difference_set = set1.difference(set2)
# 出力: set1 と set2 の差集合: {1, 2}
print(f"{set1} と {set2} の差集合: {difference_set}")

# 演算子を使用
symmetric_difference_set = set1 ^ set2
# symmetric_difference() メソッドを使用
symmetric_difference_set = set1.symmetric_difference(set2)
# 出力: set1 と set2 の対称差: {1, 2, 4, 5}
print(f"{set1} と {set2} の対称差: {symmetric_difference_set}")

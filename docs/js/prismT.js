/* Prism.plugins.matchBracesを明示化し、他のコードから検知可能にしている */
...
!function() {
    if ("undefined" != typeof Prism && "undefined" != typeof document) {
        ...
        // Register the plugin in Prism.plugins
        Prism.plugins.matchBraces = {
            register: function() {
                console.log("match-braces plugin registered successfully.");
            }
        };
